...
Production DKG is **OWNER_BLOCKED** and occurs only after Quiet Week and Bitcoin-anchor selection. Participants use independent OS CSPRNGs; deterministic dealers, seeds, embedded shares, and historical keys are forbidden. The signed ceremony records participant identity, chain ID, suite/DST, commitments, encrypted-share disposition, complaints, exclusions, transcript root, start/end, software/toolchain, and independent reproduction. Ephemeral coefficients/nonces are erased after verification.

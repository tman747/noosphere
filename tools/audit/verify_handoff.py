...
from common import AuditError, materialize_bundle, sha256_file
...
def main() -> int:
    ...
    try:
        ...
        with materialize_bundle(target) as (_, manifest):
    ...
    print(
        ...
        f"source_revision={manifest['source_revision']} bundle_id={manifest['bundle_id']} outer_sha256={outer}"
    )

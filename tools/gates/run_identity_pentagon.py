...
checks=[{'name':'local shadow identity/transcript regression','passed':True,'detail':local},{'name':'real one-witness five-path 0.5B measurement and independent disable drill','passed':False,'status':'EXTERNAL_BLOCKED','reason':'no registered real 0.5B witness corpus with measured five-path marginal cost, 15/15 mutations, and two-epoch live lane-disable evidence'}]

...
checks=[require_disabled_controls(['dream_lane_enabled']),{'name':'authority and payout boundary','passed':True,'detail':'sealed branch is private, payout-free, non-authoritative, and cannot reopen killed dream market'}]

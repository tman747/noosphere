...
checks=[evidence_check('production-influence-disabled','disabled_control',True,'universal M-HDF is retired; energy/FMM outputs are shadow credit only'),evidence_check('registered-falsifier','falsifier',True,local)]

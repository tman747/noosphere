...
checks=[require_disabled_controls(['umbra_suite_enabled']),evidence_check('saved-challenge-construction','external_requirement',False,'experiments/hfhe-refresh has no registered suite, saved challenge artifact, public proof, concrete parameters, or independent implementation')]
